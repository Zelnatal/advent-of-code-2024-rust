...
fn main() {
    let input = read_to_string("./input/day13/2.txt").unwrap();
...
fn solver(input: &str) -> usize {
    ...
    while let Some(line) = lines.next() {
        ...
        lines.next();
        machines.push((ax, ay, bx, by, px + 10000000000000, py + 10000000000000));
    }
    let mut ans = 0;
...
//     #[test]
//     fn exemple() {
//         let input = read_to_string("./input/day13/2_exemple.txt").unwrap();
